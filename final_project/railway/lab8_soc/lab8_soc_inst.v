	lab8_soc u0 (
		.beginpoint_export      (<connected-to-beginpoint_export>),      //      beginpoint.export
		.clk_clk                (<connected-to-clk_clk>),                //             clk.clk
		.endpoint_export        (<connected-to-endpoint_export>),        //        endpoint.export
		...
		.distancehigh_export    (<connected-to-distancehigh_export>),    //    distancehigh.export
		.distancelow_export     (<connected-to-distancelow_export>)      //     distancelow.export
	);
