...
# setting SOPC_SYSID_BASE_ADDRESS is 0x38
SOPC_SYSID_FLAG += --sidp=0x38
ELF_PATCH_FLAG  += --sidp 0x38

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1605800802
SOPC_SYSID_FLAG += --timestamp=1605800802
ELF_PATCH_FLAG  += --timestamp 1605800802
