...
module lab9_soc_mm_interconnect_0 (
	...
	wire  [105:0] aes_aes_slave_agent_rf_source_data;                                                 // AES_AES_Slave_agent:rf_source_data -> AES_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] aes_aes_slave_agent_rsp_fifo_out_data;                                              // AES_AES_Slave_agent_rsp_fifo:out_data -> AES_AES_Slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // AES_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [7:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AES_AES_Slave_agent:cp_channel
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> sdram_s1_agent:cp_valid
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sdram_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // sdram_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> sdram_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> sdram_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> sdram_s1_agent:cp_endofpacket
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [104:0] aes_aes_slave_agent_rp_data;                                                        // AES_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	wire  [104:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [104:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [104:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [104:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_004:sink1_data
	...
	wire  [104:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_005:sink1_data
	...
	wire  [104:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [104:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> rsp_mux_001:sink3_data
	...
	wire  [104:0] cmd_demux_src6_data;                                                                // cmd_demux:src6_data -> crosser:in_data
	...
	wire  [104:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_006:sink0_data
	...
	wire  [104:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> crosser_001:in_data
	...
	wire  [104:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_006:sink1_data
	...
	wire  [104:0] rsp_demux_006_src0_data;                                                            // rsp_demux_006:src0_data -> crosser_002:in_data
	...
	wire  [104:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink6_data
	...
	wire  [104:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> crosser_003:in_data
	...
	wire  [104:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink4_data
	...
	wire   [33:0] sdram_s1_agent_rdata_fifo_out_data;                                                 // sdram_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	...
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> sdram_s1_agent:rdata_fifo_sink_data
	...
	lab9_soc_mm_interconnect_0_router_004 router_008 (
