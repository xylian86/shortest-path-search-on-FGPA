...
// This is the specified AES InvSBox.
const uchar aes_invsbox[256] = {
...
// Rcon lookup table. Rcon[0] is filjustled  to make the index match the one 
// in the manual. The very first Rcon you will use is 0x01000000, i.e. Rcon[1]. 
uint Rcon[]={0x00000000,0x01000000,0x02000000,0x04000000,0x08000000,0x10000000,
